...
from umldiagrammer.dialogs.BaseDialog import CustomDialogButton
from umldiagrammer.dialogs.BaseDialog import CustomDialogButtons
from umldiagrammer.dialogs.BaseDialog import BaseDialog

from umldiagrammer.preferences.DiagrammerPreferences import DiagrammerPreferences


class DlgEditProjectHistory(BaseDialog):
    ...
    def _layoutSelectionControls(self, parent: SizedPanel):
        ...
        showProjectExtension: bool = DiagrammerPreferences().displayProjectExtension
